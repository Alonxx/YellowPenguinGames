      ...
      <div className="flex flex-col justify-center items-center pt-10 pb-20">
        ...
        <div className="w-[70%]">
          ...
          <h2 className="text-2xl mb-2">
            Yellow Penguin Games makes ad-supported games.
          </h2>
          <p>
            This SERVICE is provided by Yellow Penguin Games at no cost and is
            ...
            are accessible at our games unless otherwise defined in this Privacy
            Policy.
          </p>
          <h3 className="text-xl mb-1 mt-6">Information Collection and Use</h3>
          <p></p>
          ...
          <h3 className="text-xl mb-1 mt-6">Cookies</h3>
          <p>
          ...
          <h3 className="text-xl mb-1 mt-6">Service Providers</h3>
          <p>
          ...
          <h3 className="text-xl mb-1 mt-6">Security</h3>
          <p>
          ...
          <h3 className="text-xl mb-1 mt-6"> Links to Other Sites</h3>
          <p>
          ...
          <h3 className="text-xl mb-1 mt-6">Children’s Privacy</h3>
          <p>
          ...
          <h3 className="text-xl mb-1 mt-6">Changes to This Privacy</h3>
          <p>
            Policy We may update our Privacy Policy from time to time. Thus, you
            ...
            this page. This policy is effective as of 2023-07-17
          </p>
          <h3 className="text-xl mb-1 mt-6">Contact Us</h3>
          <p>
            If you have any questions or suggestions about our Privacy Policy,
            do not hesitate to contact us at alonsodiazlip@gmail.com.
          </p>
        </div>
      </div>
    </div>
